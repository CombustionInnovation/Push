...
@implementation MultiPlayerTabs
...
-(void)createTabs
{
    ...
    UIImage *pressed = [self imageWithColor:[UIColor colorWithRed:0.824 green:0.204 blue:0.039 alpha:1] /*#e9e9e9*/];
